...
def main() -> int:
    ...
    # 610 — تلغرام: منصّة المالك المتنقّلة. نسخة واحدة (قفل 8098)، والتوكن من
    ...
    print("Telegram 610     : owner mobile — lock 8098 (token: governance/scripts/secrets_admin.py set telegram_bot_token)")
