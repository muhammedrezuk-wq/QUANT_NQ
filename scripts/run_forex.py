...
# NQ_NEWS_DB يشير لـnq_brain.db حيث يكتب بوت الأخبار المنفصل (QUANT_NQ_NEWS) الأخبار
# والأجندة فعلًا — لا var/forex/news.db الفارغة (كان يخفي الأخبار عن الذرّة 615).
