#!/usr/bin/env python3
"""
governance/scripts/freeze_core.py — ختم وتجميد النواة (المادة 1 / 41 / 91 / 100)
=======================================================================
...
الحارس المحلي: `governance/checks/check_governance.py` يركّب هذا الفحص في
...
def verify(quiet: bool = False) -> int:
    if not LOCK_FILE.exists():
        print("خطأ: النواة غير مختومة — لا يوجد core/CORE.lock. نفّذ: python governance/scripts/freeze_core.py freeze")
        return 2
