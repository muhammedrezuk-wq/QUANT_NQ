...
#
# ٢٠٢٦-٠٩-٠٦ (معايرة بتفويض المالك: «يشتغل من ثواني لا دقايق معدودة»):
# المضاعف 4 كان يفرض وقفًا لا يقلّ عن 20.00، فالمخاطرة تخرج 25→30 بينما
# المستويات البنيوية المتاحة فوق السعر ضمن 16 — فتسقط النسبة إلى
# 1.02→1.33 ويُرفض كل أمر بـRR_BELOW_MIN (مقيس على أربع دورات متتالية).
# المضاعف 2 يعيد أدنى وقف إلى 10.00: وقف 10→15 يوافق صفقة تعيش ثوانيَ
# إلى دقائق معدودة كما طلب المالك، ويجعل مستويات 16 نقطة أهدافًا صالحة.
SPREAD_STOP_MULT = 2.0
# احتياطي الانزلاق كمضاعف للسبريد — مقيس على ٢٤ صفقة منفَّذة: الانزلاق
# ضدّنا (وسيط 2.7 · متوسط 4.7 · أقصى 16.90) مقابل سبريد 5.00.
#
# ٢٠٢٦-٠٩-٠٦ (حكم المالك: «ما بصير يجي التحليل مع قالب مركّب»): المضاعف
# 2 كان يحجز 10.00 للانزلاق فوق 5.00 للسبريد — خمسة عشر دولارًا ثابتة
# تُضاف إلى كل وقف مهما صغر. المقيس على أمرين حقيقيين:
#   وقف 10.00 ⇒ لوت 0.40 ⇒ المخاطرة الفعلية 4.00 لا 10
#   وقف 22.41 ⇒ لوت 0.26 ⇒ المخاطرة الفعلية 5.83 لا 10
# أي أن القالب ابتلع أكثر من نصف الميزانية، فصغّر اللوت بلا سبب من
# التحليل. المضاعف 1 يجعل الاحتياطي 5.00 — يغطّي وسيط الانزلاق (2.7)
# ومتوسطه (4.7) بالقياس، ويترك الوقف التحليلي هو من يحكم الحجم.
