...
BARE_DEFAULT_DB = "var/store/ai_journal_870.db"
_DEFAULT_DB = (lambda _p=Path(__file__).resolve(): __import__("shared.runtime_paths", fromlist=["anchored_state_path"]).anchored_state_path(BARE_DEFAULT_DB, code_root=_p))()
