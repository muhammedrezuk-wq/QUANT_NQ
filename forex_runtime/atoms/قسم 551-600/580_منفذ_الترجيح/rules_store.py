...
from ruling_math import RESTORE_JOURNAL, ID_ENGINE, ID_RULES, _valid_points, _finite, interpolate, _contract_view, _declared_unknown, _read_number, _read_state, _side_applies, EIGHT_FIELDS, FIELD_SOURCES, FIELD_DIRECTION, FIELD_STRENGTH, FIELD_CONFIDENCE, STATE_READY, STATE_NOT_READY
...
def _reject(self, reason: str, payload: Any) -> None:
    atom._commands_rejected += 1
    atom._last_reject = reason
